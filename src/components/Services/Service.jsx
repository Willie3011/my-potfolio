...
function Service({ key, service }) {
  return (
    <div
      key={key}
      className="max-sm:h-auto h-[260px] p-4 w-full border border-slate-600 bg-slate-800 hover:border-emerald-500 rounded-lg duration-200 overflow-hidden"
    >
      {/* icon */}
      ...
      {/* desc */}
      <p className="text-sm text-gray-400 font-thin text-balance my-4">
        {service.description}
      </p>
    </div>
  );
